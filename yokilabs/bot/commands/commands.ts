...
import booleanArg from "../src/args/boolean";
import channel from "../src/args/channel";
import enumArg from "../src/args/enum";
import enumList from "../src/args/enumList";
import member from "../src/args/member";
import number from "../src/args/number";
import rest from "../src/args/rest";
import stringArg from "../src/args/string";
import UUID from "../src/args/UUID";
...
>(roleValues: Record<TRoleType, number>) {
    ...
    return {
        fetchPrefix: (onNext: (packet: MessagePayload, ctx: TClient, server: TServer, prefix: string) => AsyncUnit, packet: MessagePayload, ctx: TClient, server: TServer) => {
        ...
        parseCommand: (
            executeCommand: (packet: MessagePayload, ctx: TClient, server: TServer, prefix: string, command: TCommand | undefined, args: string[]) => AsyncUnit,
