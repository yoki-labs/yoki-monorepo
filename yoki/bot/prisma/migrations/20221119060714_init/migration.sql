/*
  ...
  - A unique constraint covering the columns `[serverId,preset]` on the table `Preset` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Preset_serverId_preset_key" ON "Preset"("serverId", "preset");
