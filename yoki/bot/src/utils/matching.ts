...
export type UrlRegexGroups
    = { full_subdomain?: string; full_domain?: string; full_route?: string; routed_subdomain?: string; routed_domain?: string; routed_route?: string; short_domain?: string };
