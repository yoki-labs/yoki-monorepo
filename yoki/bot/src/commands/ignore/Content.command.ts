...
const IgnoreContent: Command = {
    ...
    usage: "<content type to ignore> <url/invite/automod> [remove]",
    ...
    args: [
        { name: "content", type: "enum", values: ContentIgnoreType },
    ...
    execute: async (message, args, ctx) => {
        const contentType = args.content as ContentIgnoreType;
