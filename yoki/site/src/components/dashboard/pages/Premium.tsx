    ...
    render() {
        ...
        return (
            <Box className="grid sm:grid-cols-1 md:grid-cols-3 xlg:grid-cols-3 gap-7">
                <PremiumTier subscribedIconClassName="from-rose-500 to-orange-500" subscribed={true} tier={"Copper"} price={5} perks={tierPerks.Copper} />
                <PremiumTier subscribedIconClassName="from-cyan-500 to-purple-400" subscribed={true} tier={PremiumType.Silver} price={10} perks={tierPerks.Copper.concat(...tierPerks.Silver)} />
                <PremiumTier subscribedIconClassName="from-red-400 to-yellow-500" subscribed={true} tier={PremiumType.Gold} price={20} perks={tierPerks.Copper.concat(...tierPerks.Silver).concat(...tierPerks.Gold)} />
            </Box>
        );
    }
}
