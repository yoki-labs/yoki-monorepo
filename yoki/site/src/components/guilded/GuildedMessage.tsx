            ...
            <Stack direction="row">
                ...
                <Box sx={{ flex: "1" }}>
                    <Stack direction="row" alignItems="center" sx={{ mb: 1 }} className="gap-2 md:gap-4">
                        ...
                        { bot && <Typography component="span" sx={{ px: 1 }} level="body-md" fontSize="xs" fontWeight="bolder" color="neutral" variant="solid">BOT</Typography> }
                        <Typography component="span" level="body-md" className="hidden md:block">2:00 PM</Typography>
                    </Stack>
