...
export const mixHexColours = (c1: string, c2: string, p1: number) => getHexString(mixColours(getDecimalValue(c1), getDecimalValue(c2), p1));

export const greyscaleHexColour = (c: string, p2: number) => getHexString(greyscaleColour(getDecimalValue(c), p2));
