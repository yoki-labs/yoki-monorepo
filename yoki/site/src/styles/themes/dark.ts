...
export const labsDarkTheme: ColorSystemOptions = {
    ...
    palette: {
        ...
        neutral: {
            ...
            solidColor: labsTheme.spacedark.foreground[700],
            solidBg: labsTheme.spacedark.background[950],
            solidBorder: "transparent",
            solidHoverBg: labsTheme.spacedark.background[950],
            solidActiveBg: labsTheme.spacedark.background[950],
            // Plain components
            ...
            plainActiveColor: labsTheme.spacedark.foreground[400],
            // Soft components
