...
client.on("messageCreated", async message => {
    ...
    return message.reply(new Embed()
        .setTitle("Tuxedo has shutdown.")
        .setColor("red")
        .setDescription(stripIndents`
            Tuxedo will not be responding to any commands. Please refer to [this post](https://www.guilded.gg/Yoki/blog/News/Shutdown-Complete) for more information.
