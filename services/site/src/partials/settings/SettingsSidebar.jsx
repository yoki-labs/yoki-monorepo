  ...
  return (
    <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-slate-200 min-w-60 md:space-y-3">
      ...
      <div>
        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/account" activeClass="bg-indigo-50" className="flex items-center px-2.5 py-2 rounded whitespace-nowrap">
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/apps" activeClass="bg-indigo-50" className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap`}>
              <svg className="w-4 h-4 shrink-0 fill-current text-slate-400 mr-2" viewBox="0 0 16 16">
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/plans" activeClass="bg-indigo-50" className="flex items-center px-2.5 py-2 rounded whitespace-nowrap">
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/billing" activeClass="bg-indigo-50" className="flex items-center px-2.5 py-2 rounded whitespace-nowrap">
      ...
      <div>
        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/feedback" activeClass="bg-indigo-50" className="flex items-center px-2.5 py-2 rounded whitespace-nowrap">
